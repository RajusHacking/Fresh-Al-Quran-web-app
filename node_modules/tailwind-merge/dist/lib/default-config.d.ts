...
export declare function getDefaultConfig(): {
    ...
    readonly theme: {
        ...
        readonly skew: readonly [typeof isInteger, typeof isArbitraryValue];
    ...
    readonly classGroups: {
        ...
        readonly 'col-start': readonly [{
            readonly 'col-start': readonly ["auto", typeof isInteger];
        }];
        /**
         * Grid Column End
         * @see https://tailwindcss.com/docs/grid-column
        ...
        readonly 'col-end': readonly [{
            readonly 'col-end': readonly ["auto", typeof isInteger];
        }];
        /**
         * Grid Template Rows
        ...
        readonly 'row-start': readonly [{
            readonly 'row-start': readonly ["auto", typeof isInteger];
        }];
        /**
         * Grid Row End
         * @see https://tailwindcss.com/docs/grid-row
        ...
        readonly 'row-end': readonly [{
            readonly 'row-end': readonly ["auto", typeof isInteger];
        }];
        /**
         * Grid Auto Flow
        ...
        readonly 'justify-content': readonly [{
            readonly justify: readonly ["start", "end", "center", "between", "around", "evenly"];
        }];
        /**
         * Justify Items
        ...
        readonly 'align-content': readonly [{
            readonly content: readonly ["start", "end", "center", "between", "around", "evenly", "baseline"];
        }];
        /**
         * Align Items
        ...
        readonly 'place-content': readonly [{
            readonly 'place-content': readonly ["start", "end", "center", "between", "around", "evenly", "baseline", "stretch"];
        }];
        /**
         * Place Items
        ...
        readonly 'min-w': readonly [{
            readonly 'min-w': readonly ["min", "max", "fit", typeof isLength];
        }];
        /**
         * Max-Width
        ...
        readonly 'max-w': readonly [{
            ...
            }, typeof isTshirtSize, typeof isArbitraryLength];
        }];
        /**
         * Height
         ...
         */
        readonly h: readonly [{
            readonly h: readonly [import("./types").ThemeGetter, "auto", "min", "max", "fit"];
        }];
        /**
         * Min-Height
        ...
        readonly 'min-h': readonly [{
            readonly 'min-h': readonly ["min", "max", "fit", typeof isLength];
        }];
        /**
         * Max-Height
        ...
        readonly 'max-h': readonly [{
            readonly 'max-h': readonly [import("./types").ThemeGetter, "min", "max", "fit"];
        }];
        /**
         * Font Size
        ...
        readonly tracking: readonly [{
            readonly tracking: readonly ["tighter", "tight", "normal", "wide", "wider", "widest", typeof isArbitraryLength];
        }];
        /**
         * Line Height
        ...
        readonly leading: readonly [{
            readonly leading: readonly ["none", "tight", "snug", "normal", "relaxed", "loose", typeof isLength];
        }];
        /**
         * List Style Type
        ...
        readonly 'underline-offset': readonly [{
            readonly 'underline-offset': readonly ["auto", typeof isLength];
        }];
        /**
        ...
        readonly indent: readonly [{
            readonly indent: readonly [import("./types").ThemeGetter];
        }];
        /**
         * Vertical Alignment
        ...
        readonly 'vertical-align': readonly [{
            readonly align: readonly ["baseline", "top", "middle", "bottom", "text-top", "text-bottom", "sub", "super", typeof isArbitraryLength];
        }];
        /**
         * Whitespace
        ...
        readonly 'outline-offset': readonly [{
            readonly 'outline-offset': readonly [typeof isLength];
        }];
        /**
         * Outline Width
        ...
        readonly duration: readonly [{
            readonly duration: readonly [typeof isInteger];
        }];
        /**
        ...
        readonly delay: readonly [{
            readonly delay: readonly [typeof isInteger];
        }];
        /**
         * Animation
        ...
        readonly 'scroll-m': readonly [{
            readonly 'scroll-m': readonly [import("./types").ThemeGetter];
        }];
        /**
         * Scroll Margin X
         * @see https://tailwindcss.com/docs/scroll-margin
        ...
        readonly 'scroll-mx': readonly [{
            readonly 'scroll-mx': readonly [import("./types").ThemeGetter];
        }];
        /**
         * Scroll Margin Y
         * @see https://tailwindcss.com/docs/scroll-margin
        ...
        readonly 'scroll-my': readonly [{
            readonly 'scroll-my': readonly [import("./types").ThemeGetter];
        }];
        /**
         * Scroll Margin Top
         * @see https://tailwindcss.com/docs/scroll-margin
        ...
        readonly 'scroll-mt': readonly [{
            readonly 'scroll-mt': readonly [import("./types").ThemeGetter];
        }];
        /**
         * Scroll Margin Right
         * @see https://tailwindcss.com/docs/scroll-margin
        ...
        readonly 'scroll-mr': readonly [{
            readonly 'scroll-mr': readonly [import("./types").ThemeGetter];
        }];
        /**
        ...
        readonly 'scroll-mb': readonly [{
            readonly 'scroll-mb': readonly [import("./types").ThemeGetter];
        }];
        /**
         * Scroll Margin Left
         * @see https://tailwindcss.com/docs/scroll-margin
        ...
        readonly 'scroll-ml': readonly [{
            readonly 'scroll-ml': readonly [import("./types").ThemeGetter];
        }];
        /**
         * Scroll Padding
        ...
        readonly 'scroll-p': readonly [{
            readonly 'scroll-p': readonly [import("./types").ThemeGetter];
        }];
        /**
         * Scroll Padding X
         * @see https://tailwindcss.com/docs/scroll-padding
        ...
        readonly 'scroll-px': readonly [{
            readonly 'scroll-px': readonly [import("./types").ThemeGetter];
        }];
        /**
         * Scroll Padding Y
         * @see https://tailwindcss.com/docs/scroll-padding
        ...
        readonly 'scroll-py': readonly [{
            readonly 'scroll-py': readonly [import("./types").ThemeGetter];
        }];
        /**
         * Scroll Padding Top
         * @see https://tailwindcss.com/docs/scroll-padding
        ...
        readonly 'scroll-pt': readonly [{
            readonly 'scroll-pt': readonly [import("./types").ThemeGetter];
        }];
        /**
        ...
        readonly 'scroll-pr': readonly [{
            readonly 'scroll-pr': readonly [import("./types").ThemeGetter];
        }];
        /**
        ...
        readonly 'scroll-pb': readonly [{
            readonly 'scroll-pb': readonly [import("./types").ThemeGetter];
        }];
        /**
         * Scroll Padding Left
         * @see https://tailwindcss.com/docs/scroll-padding
        ...
        readonly 'scroll-pl': readonly [{
            readonly 'scroll-pl': readonly [import("./types").ThemeGetter];
        }];
        /**
         * Scroll Snap Align
    ...
    readonly conflictingClassGroups: {
        ...
        readonly inset: readonly ["inset-x", "inset-y", "top", "right", "bottom", "left"];
        ...
        readonly p: readonly ["px", "py", "pt", "pr", "pb", "pl"];
        readonly px: readonly ["pr", "pl"];
        readonly py: readonly ["pt", "pb"];
        readonly m: readonly ["mx", "my", "mt", "mr", "mb", "ml"];
        ...
        readonly 'scroll-m': readonly ["scroll-mx", "scroll-my", "scroll-mt", "scroll-mr", "scroll-mb", "scroll-ml"];
        readonly 'scroll-mx': readonly ["scroll-mr", "scroll-ml"];
        readonly 'scroll-my': readonly ["scroll-mt", "scroll-mb"];
        readonly 'scroll-p': readonly ["scroll-px", "scroll-py", "scroll-pt", "scroll-pr", "scroll-pb", "scroll-pl"];
