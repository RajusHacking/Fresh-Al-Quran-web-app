import os
from store import file_names_jsx, surah_name_bn, surah_number_bn,surah_means_bn, total_verses_bn, surah_place_bn, file_names_json

# Function to generate content for each file
def generate_jsx_content(file_name, surah_name, getsurah_number_bn,getsurah_means_bn, gettotal_verses_bn, getsurah_name_bn, getsurah_place_bn, getfile_names_json):
    component_name = file_name[:-4]  # Remove the file extension
    content = f"""
...
import Surah__info from "../../../Json/surah/{getfile_names_json}";
...
const {component_name} = () => {{
    ...
    const number = "{getsurah_number_bn}";
	const name = "{getsurah_name_bn}";
	const means = "{getsurah_means_bn}";
	const verse_num_bn = "{gettotal_verses_bn}";
	const place = "{getsurah_place_bn}";
...
# Create JSX files in the specified folder
def create_jsx_files(file_names_jsx, surah_name_bn, folder_path):
    # Create the folder if it doesn't exist
    if not os.path.exists(folder_path):
        os.makedirs(folder_path)
    
    for file_name, surah_name, getsurah_number_bn, getsurah_means_bn, gettotal_verses_bn, getsurah_name_bn, getsurah_place_bn , getfile_names_json in zip(file_names_jsx, surah_name_bn, surah_number_bn, surah_means_bn, total_verses_bn, surah_name_bn, surah_place_bn, file_names_json):
        
        file_content = generate_jsx_content(file_name, surah_name, getsurah_number_bn,getsurah_means_bn, gettotal_verses_bn, getsurah_name_bn, getsurah_place_bn, getfile_names_json)
