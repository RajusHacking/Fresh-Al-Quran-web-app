...
import json
from store import total_verses_en, file_names_json
...
if res.status_code == 200:
    ...
    if req.status_code == 200 :
        ...
        arabic_text = []
        catch_arabic_text = surah_soup.find_all('div', {"class" : "verse-card_verse_text__29N5F text_arabic"})
        ...
        tafceer_text = []
        catch_tafceer_text = surah_soup.find_all('p', {"class" : "verse-card_verse_text__29N5F text_trans"})
