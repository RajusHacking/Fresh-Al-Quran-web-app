...
import Surah__info from "../../../Json/surah/_25_al_furqan.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _25_al_furqan = () => {

    const number = "২৫";
	const name = "আল-ফুরক্বন";
	const means = "সত্য মিথ্যার পার্থক্যকারী গ্রন্থ্য";
	const verse_num_bn = "৭৭";
	const place = "মক্কা";
