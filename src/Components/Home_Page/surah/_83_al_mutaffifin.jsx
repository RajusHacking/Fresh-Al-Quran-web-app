...
import Surah__info from "../../../Json/surah/_83_al_mutaffifin.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _83_al_mutaffifin = () => {

    const number = "৮৩";
	const name = "আল-মুতাফফিফীন";
	const means = "প্রতারকগণ";
	const verse_num_bn = "৩৬";
	const place = "মদিনা";
...
export default _83_al_mutaffifin
