...
import Surah__info from "../../../Json/surah/_98_al_bayyinah.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _98_al_bayyinah = () => {

    const number = "৯৮";
	const name = "আল-বায়্যিনাহ";
	const means = "সুস্পষ্ট প্রমাণ";
...
export default _98_al_bayyinah
