...
import Surah__info from "../../../Json/surah/_102_at_takathur.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _102_at_takathur = () => {

    const number = "১০২";
	const name = "আত-তাকাসুর";
	const means = "প্রাচুর্য্যের প্রতিযোগিতা";
	const verse_num_bn = "৮";
	const place = "মদিনা";
...
export default _102_at_takathur
