...
import Surah__info from "../../../Json/surah/_51_adh_dhariyat.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _51_adh_dhariyat = () => {

    const number = "৫১";
	const name = "আয-যারিয়াত";
	const means = "বিক্ষিপ্তকারী বাতাস";
	const verse_num_bn = "৬০";
	const place = "মদিনা";
...
export default _51_adh_dhariyat
