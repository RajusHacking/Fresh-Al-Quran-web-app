...
import Surah__info from "../../../Json/surah/_5_al_maidah.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _5_al_maidah = () => {

    const number = "৫";
	const name = "আল-মায়িদা";
	const means = "খাদ্য পরিবেশিত টেবিল";
	const verse_num_bn = "১২০";
	const place = "মদিনা";
