...
import Surah__info from "../../../Json/surah/_60_al_mumtahanah.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _60_al_mumtahanah = () => {

    const number = "৬০";
	const name = "আল-মুমতাহিনা";
	const means = "নারি, যাকে পরীক্ষা করা হবে";
	const verse_num_bn = "১৩";
	const place = "মদিনা";
...
export default _60_al_mumtahanah
