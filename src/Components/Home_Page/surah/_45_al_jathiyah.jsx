...
import Surah__info from "../../../Json/surah/_45_al_jathiyah.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _45_al_jathiyah = () => {

    const number = "৪৫";
	const name = "আল-জাসিয়াহ";
	const means = "হাঁটু গেড়ে বসা";
	const verse_num_bn = "৩৭";
	const place = "মক্কা";
...
export default _45_al_jathiyah
