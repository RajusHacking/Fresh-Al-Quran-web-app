...
import Surah__info from "../../../Json/surah/_64_at_taghabun.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _64_at_taghabun = () => {

    const number = "৬৪";
	const name = "আত-তাগ্ববুন";
	const means = "মোহ অপসারণ";
	const verse_num_bn = "১৮";
	const place = "মদিনা";
...
export default _64_at_taghabun
