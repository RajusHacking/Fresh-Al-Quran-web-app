...
import Surah__info from "../../../Json/surah/_56_al_waqiah.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _56_al_waqiah = () => {

    const number = "৫৬";
	const name = "আল-ওয়াক্বিয়াহ";
	const means = "নিশ্চিত ঘটনা";
	const verse_num_bn = "৯৬";
	const place = "মদিনা";
