...
import Surah__info from "../../../Json/surah/_73_al_muzzammil.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _73_al_muzzammil = () => {

    const number = "৭৩";
	const name = "আল-মুযযাম্মিল";
	const means = "বস্ত্রাচ্ছাদনকারী";
	const verse_num_bn = "২০";
	const place = "মক্কা";
...
export default _73_al_muzzammil
