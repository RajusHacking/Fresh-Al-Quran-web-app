...
import Surah__info from "../../../Json/surah/_37_as_saffat.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _37_as_saffat = () => {

    const number = "৩৭";
	const name = "আস-সাফফাত";
	const means = "সারিবদ্ধভাবে দাড়ানো";
	const verse_num_bn = "১৮২";
	const place = "মক্কা";
