...
import Surah__info from "../../../Json/surah/_43_az_zukhruf.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _43_az_zukhruf = () => {

    const number = "৪৩";
	const name = "আয-যুখরুফ";
	const means = "সোনাদানা";
	const verse_num_bn = "৮৯";
	const place = "মক্কা";
