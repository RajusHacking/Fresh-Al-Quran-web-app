...
import Surah__info from "../../../Json/surah/_84_al_inshiqaq.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _84_al_inshiqaq = () => {

    const number = "৮৪";
	const name = "আল-ইনশিক্বক্ব";
	const means = "খন্ড-বিখন্ড করণ";
	const verse_num_bn = "২৫";
	const place = "মক্কা";
...
export default _84_al_inshiqaq
