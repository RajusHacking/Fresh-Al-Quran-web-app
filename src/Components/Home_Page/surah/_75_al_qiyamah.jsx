...
import Surah__info from "../../../Json/surah/_75_al_qiyamah.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _75_al_qiyamah = () => {

    const number = "৭৫";
	const name = "আল-ক্বিয়ামাহ";
	const means = "মহাপ্রলয়";
	const verse_num_bn = "৪০";
	const place = "মক্কা";
