...
import Surah__info from "../../../Json/surah/_23_al_muminun.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _23_al_muminun = () => {

    const number = "২৩";
	const name = "আল-মুমিনুন";
	const means = "একনিষ্ঠ বান্দাগণ";
	const verse_num_bn = "১১৮";
	const place = "মক্কা";
