...
import Surah__info from "../../../Json/surah/_58_al_mujadalah.json";
import { MdKeyboardArrowDown } from "react-icons/md";
import {ScrollRestoration} from "react-router-dom";

   
const _58_al_mujadalah = () => {

    const number = "৫৮";
	const name = "আল-মুজাদালা";
	const means = "অনুুযোগকারিণী";
	const verse_num_bn = "২২";
	const place = "মদিনা";
...
export default _58_al_mujadalah
