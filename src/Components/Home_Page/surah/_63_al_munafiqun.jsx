...
import Surah__info from "../../../Json/surah/_63_al_munafiqun.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _63_al_munafiqun = () => {

    const number = "৬৩";
	const name = "আল-মুনাফিক্বূন";
	const means = "মিথ্যাবাদীগণ";
...
export default _63_al_munafiqun
