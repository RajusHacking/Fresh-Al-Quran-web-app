...
import Surah__info from "../../../Json/surah/_74_al_muddaththir.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _74_al_muddaththir = () => {

    const number = "৭৪";
	const name = "আল-মুদ্দাসসির";
	const means = "বস্ত্রাবৃত";
	const verse_num_bn = "৫৬";
	const place = "মক্কা";
...
export default _74_al_muddaththir
