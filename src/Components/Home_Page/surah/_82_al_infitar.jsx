...
import Surah__info from "../../../Json/surah/_82_al_infitar.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _82_al_infitar = () => {

    const number = "৮২";
	const name = "আল-ইনফিতার";
	const means = "বিদীর্ণ করা";
	const verse_num_bn = "১৯";
	const place = "মক্কা";
