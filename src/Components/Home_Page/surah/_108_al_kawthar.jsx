...
import Surah__info from "../../../Json/surah/_108_al_kawthar.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _108_al_kawthar = () => {

    const number = "১০৮";
	const name = "আল-কাউসার";
	const means = "প্রাচুর্য";
	const verse_num_bn = "৩";
	const place = "মক্কা";
...
export default _108_al_kawthar
