...
import Surah__info from "../../../Json/surah/_104_al_humazah.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _104_al_humazah = () => {

    const number = "১০৪";
	const name = "আল-হুমাযা";
	const means = "পরনিন্দাকারী";
	const verse_num_bn = "৯";
	const place = "মক্কা";
...
export default _104_al_humazah
