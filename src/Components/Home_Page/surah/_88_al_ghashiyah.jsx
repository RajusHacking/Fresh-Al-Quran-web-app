...
import Surah__info from "../../../Json/surah/_88_al_ghashiyah.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _88_al_ghashiyah = () => {

    const number = "৮৮";
	const name = "আল-গ্বশিয়া";
	const means = "বিহ্বলকর ঘটনা";
	const verse_num_bn = "২৬";
	const place = "মক্কা";
...
export default _88_al_ghashiyah
