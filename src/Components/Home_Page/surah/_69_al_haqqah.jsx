...
import Surah__info from "../../../Json/surah/_69_al_haqqah.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _69_al_haqqah = () => {

    const number = "৬৯";
	const name = "আল-হাক্ব-ক্বহ";
	const means = "নিশ্চিত সত্য";
	const verse_num_bn = "৫২";
	const place = "মক্কা";
