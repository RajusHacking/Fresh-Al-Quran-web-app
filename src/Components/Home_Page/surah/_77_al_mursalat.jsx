...
import Surah__info from "../../../Json/surah/_77_al_mursalat.json";
import { MdKeyboardArrowDown } from "react-icons/md";
   
const _77_al_mursalat = () => {

    const number = "৭৭";
	const name = "আল-মুরসালাত";
	const means = "প্রেরিত পুরুষগণ";
	const verse_num_bn = "৫০";
	const place = "মক্কা";
...
export default _77_al_mursalat
